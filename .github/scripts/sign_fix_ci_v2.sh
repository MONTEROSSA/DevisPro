...
TEAM="T3VS7P5X5D"
SRC="${HOME}/Desktop/DevisPro.app"
WORK="${HOME}/devis-auto/_signFIX"
APP="$WORK/DevisPro.app"
MACOS="$APP/Contents/MacOS"
OLD="$MACOS/DevisPro"
SIGNED="$WORK/s.zip"
NOTAR="${HOME}/devis-auto/DevisPro_Mac_notarized.zip"
...
DESK="${HOME}/Desktop/DevisPro.app"
if [ -d "$APP" ]; then
  rm -rf "$DESK"
  cp -R "$APP" "$DESK"
