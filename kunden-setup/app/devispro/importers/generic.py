...
_PATTERNS = {
    "pos_nr": ("position", "pos", "nr", "nummer", "lfd"),
    "text": ("text", "bezeichnung", "beschrieb", "leistung", "positionstext", "objekt"),
    "menge": ("menge", "quant", "qty", "anzahl", "meng"),
    "einheit": ("einheit", "unit", "eh", "mass"),
    "ep": ("ep", "einheitspreis", "preis", "ansatz", "preis/chf"),
    "betrag": ("betrag", "total", "summe", "kosten", "gesamt"),
}
