...
version.json auf devispro.ch ab. Ist eine neuere Version verfuegbar,
...
# Zentrale Versionsdatei (vom Anbieter auf devispro.ch hochgeladen)
DEFAULT_URL = os.environ.get(
    "DEVISPRO_UPDATE_URL",
    "https://devispro.ch/version.json",
)
...
def check(force: bool = False, url: str = DEFAULT_URL) -> dict:
    ...
    return {
        ...
        "url": latest.get("download_url", "https://devispro.ch"),
...
def render_banner(check_result: dict, lang: str = "de") -> str:
    ...
    url = check_result.get("url", "https://devispro.ch")
    return f"""
