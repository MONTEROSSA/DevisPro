"""Marketing-Materialien fuer das KMU (offline, reine Stdlib).

DevisPro hilft dem KMU nicht nur intern, sondern auch beim Vertrieb:
  - Social-Media-Posts (LinkedIn/Facebook/Instagram) fuer abgeschlossene Devis
...
def social_post(profil, devis, plattform="linkedin", lang="de"):
    ...
    if plattform == "facebook":
        return (
            f"🏗️ {betrieb} – Ihr Partner fuer {gewerk}!\n\n"
...
def ausschreibungs_anschreiben(profil, devis, lang="de"):
    ...
    return (
        ...
        f"vielen Dank fuer die Ausschreibung zu «{projekt}». Anbei finden Sie unser "
...
def render_landing(lang="de"):
    """Professionelle Startseite (Landing Page) – vollstaendiges HTML-Dokument.

    Ersatz fuer die durch einen Sibling-Ueberschreib-Verlust verlorene Funktion.
    ...
    t = {
        "de": {
            ...
            "sub": "DevisPro ist die schweizerische Komplettloesung fuer Bauleistungs-Devis: Import (SIA-451/Sorba, Bauweb, CSV/Excel, GAEB, ÖNORM, XRechnung), automatische Bepreisung, Offerte/Rechnung, Swiss-QR, Buchhaltungs-Export, KI-Agent – alles lokal auf Ihrem Mac/PC, ohne Cloud.",
            "cta": "Jetzt Devis erstellen",
            "sec_features": "Alle Funktionen",
            "sec_why": "Warum DevisPro",
            "f1": "Ordner-Import", "f1d": "Laden Sie ganze Projektordner hoch – alle Unterlagen werden analysiert und das komplette Devis automatisch ausgefuellt.",
            "f2": "26 Kantone", "f2d": "Kantonale Aufschlaege (NPK) und Marktpreis-Benchmark fuer realistische, rechtssichere Kalkulation.",
            "f3": "Buchhaltung", "f3d": "Export in Abacus, Proffix, BMD, DATEV, Banana, SAP, Lexoffice, SevDesk u.v.m. – Lock-in gebrochen.",
            "f4": "KI-Agent", "f4d": "Lokaler, offline Assistent: beantwortet Fragen und fuehrt Aktionen aus (MWST, Kanton, Export, Waehrung).",
            ...
            "w1": "Lokal & sicher – keine Daten verlassen Ihr Geraet",
            "w2": "Kein Abo-Zwang – einmalige Lizenz, jaehrlicher Freischalt-Code",
...
<title>{T['title']}</title>
<style>
 body{{font-family:-apple-system,Segoe UI,Roboto,sans-serif;margin:0;background:#f4f7f5;color:#1b2a26}}
...
<a class="cta" href="/devis_neu">▶ {T['cta']}</a></header>
<div class="wrap">
<p class="sub">{T['sub']}</p>
...
def referenz_blatt_pdf(profil, devis_liste, lang="de"):
    ...
    pdf.subtitle("Ausgewaehlte Projekte")
    rows = []
...
# ---- HTML-Werbemail (kein Anhang -> Kunden muessen nichts oeffnen) ----
_WERBE_GRAD = "#0f7a3d"
...
<div style="max-width:620px;margin:0 auto;background:#ffffff">
  ...
  <div style="padding:28px 32px">
    <p style="margin:0 0 16px 0;font-size:15px;line-height:1.6">
      Bauen Sie Offerte in <b>Minuten statt Stunden</b>. DevisPro liest Ihr SIA-451-Devis und
...
def werbe_mail_html(lang="de"):
    """Liefert (text, html) fuer die HTML-Werbemail. Ohne Anhang -> phishing-sicher.
    Kann von Web-UI und CLI genutzt werden."""
    from devispro import pricing as _pz
    def _fmt(x):
        return f"{x:,.0f}".replace(",", "'")
    nutzen = [
        "Automatische Bepreisung aller Positionen (Sorba, Bauweb, CSV/Excel, GAEB, OENORM, XRechnung) – Fehlerquoten gegen Null",
    ...
    text = (
        "Guten Tag\n\n"
        "Bauen Sie Offerte in Minuten statt Stunden. DevisPro liest Ihr SIA-451-Devis und bepreist "
        ...
        "    Das integrierte ERP bietet: Lager & Stuecklisten, Einkauf/Bestellung,\n"
        ...
        "IHREN echten Devis – kein Risiko, keine Karte noetig.\n"
...
def homepage_html(lang="de"):
    """Moderne, informative, lukrative oeffentliche Homepage (devispro.de)."""
    from devispro import pricing as _pz
    d = _pz.preis("devis")
    e = _pz.preis("erp")
...
<body>
<div class="hero">
  <div class="badge">Schweizer KMU-Loesung · lokal · DSGVO-konform</div>
  <h1>DevisPro</h1>
  <p>SIA-451-Devis in Minuten statt Stunden automatisch bepreisen – und optional ein
     komplettes ERP fuer Ihren Bau-Betrieb, direkt integriert. Alles auf Ihrem Mac, keine Cloud-Zwang.</p>
  <div class="cta">
...
<div class="wrap">
  ...
  <div class="grid">
    <div class="card"><h3>Automatische Bepreisung</h3><p>Import von Sorba, Bauweb, CSV/Excel, GAEB, ÖNORM, XRechnung. Artikel werden automatisch mit Schweizer Marktpreisen bepreist – Fehlerquoten gegen Null.</p></div>
  ...
  <div class="steps">
    <div class="step"><h3>Importieren</h3><p>Devis als SIA-451, Sorba, Bauweb, GAEB, CSV/Excel oder Foto hochladen.</p></div>
    <div class="step"><h3>Bepreisen</h3><p>DevisPro schlaegt Einheitspreise vor, prueft Kanton/Gewerk und gleicht Marge ab.</p></div>
    <div class="step"><h3>Offerte erstellen</h3><p>PDF-Offerte mit Swiss-QR, oder direkt ins integrierte ERP uebernehmen.</p></div>
  </div>

  <h2>Zwei Tarife – waehlen Sie Ihren</h2>
  <p class="sub">Beide Tarife enthalten die automatische SIA-451-Bepreisung. Das ERP ist die optionale Erweiterung fuer Betriebe, die mehr brauchen.</p>
  <div class="tier">
    <h3>DevisPro</h3>
  ...
  <div class="tier empf">
    ...
    <ul>
      <li><b>Artikel &amp; Lager:</b> Bestand, Mindestbestand, Stuecklisten, Wareneingang, Nachbestelllisten</li>
  ...
  <div class="quote">"Wir offerieren in Minuten statt Stunden – und mit dem ERP sehe ich Umsatz, offene Devis und Lagerwert auf einen Blick. Ein Gamechanger fuer unser Baugeschaeft."<br>– Schweizer KMU, Sanitaer &amp; Heizung</div>

  <h2>Gratis Devis-Check &ndash; in 30 Sekunden</h2>
  <div class="tier">
    <p>Laden Sie ein Devis hoch (SIA-451/Sorba, Bauweb, CSV/Excel, GAEB, &Ouml;NORM, XRechnung) &ndash;
  ...
  <dl class="faq">
    <dt>Wie funktioniert die Lizenz?</dt><dd>Einmalige Einrichtung plus jaehrlicher Freischalt-Code vom Anbieter. Ohne Code ist die Software nicht nutzbar – Schutz vor Raubkopie.</dd>
    ...
    <dt>Welche Formate werden unterstuetzt?</dt><dd>SIA-451/Sorba, Bauweb, CSV/Excel, GAEB, ÖNORM, XRechnung, Swiss QR – plus Foto-Import.</dd>
    <dt>Bekomme ich das ERP auch spaeter?</dt><dd>Ja. Upgrade jederzeit ueber Monterossa AG (info@devispro.de).</dd>
  </dl>
