import os
P="/Users/ferdinandrothlisberger/devis-auto/devispro/erp_ui.py"
content='"""ERP-Web-UI (stdlib, keine Flask). Voll bedienbares ERP-Dashboard: Dashboard,
...
print("erp_ui.py neu geschrieben:", len(content), "Zeichen")
